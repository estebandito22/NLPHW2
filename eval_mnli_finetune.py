...
rnn_model_dir = os.path.join(
    os.getcwd(), 'outputs',
    'LI_wed_300_we_True_et_rnn_hd_16_do_0.2_vs_50000_nl_1_lr_0.01')
rnn_epoch = 8

conv_model_dir = os.path.join(
    os.getcwd(), 'outputs',
    'LI_wed_300_we_True_et_conv_hd_512_ks_5_do_0.05_vs_50000_nl_1_lr_0.001')
conv_epoch = 6
...
for mask in val_genre_masks:
    ...
    #
    val_dataset = NLIDataset(prop, hyp, labels, data['max_sent_len_mnli.val'])
...
#
results.to_csv(os.getcwd(), 'outputs', 'genre_report.csv')
